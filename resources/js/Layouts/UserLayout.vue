...
<template>
  <div class="w-full h-full mt-16">
    <aside
      class="ml-[-100%] fixed z-10 top-0 pb-3 px-6 w-full flex flex-col justify-between h-screen bg-white rounded-xl transition duration-300 md:w-4/12 lg:ml-0 lg:w-[25%] xl:w-[20%] 2xl:w-[15%]"
    >
      <div>
    ...
    <div class="ml-auto mb-6 lg:w-[75%] xl:w-[80%] 2xl:w-[85%]">
      <div
        class="fixed pt top-0 w-full bg-white lg:py-2.5 lg:w-[85%] xl:w-[80%] 2xl:w-[85%]"
      >
        <div
