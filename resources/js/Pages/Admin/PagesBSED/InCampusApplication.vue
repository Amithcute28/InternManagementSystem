...
watch(search, (value) => {
  router.get('in-campus-applicationbsed', { search: value }, {
    preserveState: true,
    replace: true
  });
});
...
function getTags() {
  router.get('in-campus-applicationbsed', { perPage: perPage.value }, {
    preserveState: true,
    replace: true,
  })
};
           ...
           <TableDataCell>
            ...
            > -->
             <TableDataCell class="space-x-4">
               <Link
                  :href="route('applicationsbsed.updateIncampus', form.id)" 
                  method="PUT" 
                  as="button"
                ...
                >
                <Link
                  :href="route('applicationsbsed.edit', form.id)"
                  class="text-green-400 hover:text-green-600"
                  >Edit</Link
                >
                <Link
                  :href="route('applicationsbsed.destroy', form.id)"
                  method="DELETE"
                  as="button"
