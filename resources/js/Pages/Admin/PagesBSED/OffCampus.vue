...
watch(search, (value) => {
  router.get('offcampusbsed', { search: value }, {
    preserveState: true,
    replace: true
  });
});
...
function getTags() {
  router.get('offcampusbsed', { perPage: perPage.value }, {
    preserveState: true,
    replace: true,
  })
};
          ...
          <select
            ...
            <Table>
                    ...
                    <template #default>
                       ...
                       <TableRow class="overflow-auto" v-for="student in students.data" :key="student.id">
              ...
              ></TableDataCell>
                            ...
                            <TableDataCell class="space-x-4">
                                <Link :href="route('offcampusbsed.show', student.id)"  class="text-green-400 hover:text-green-600">View</Link>
