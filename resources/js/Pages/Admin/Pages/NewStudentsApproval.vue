...
const form = useForm({
        student_id: props.newstudent?.student_id,
        program: props.newstudent?.program,
        year_level: props.newstudent?.year_level,
        full_name: props.newstudent?.full_name,
        email: props.newstudent?.email,
        birthday: props.newstudent?.birthday,
        gender: props.newstudent?.gender,
        relationship: props.newstudent?.relationship,
        nationality: props.newstudent?.nationality,
        contact_number: props.newstudent?.contact_number,
...
const submit = () => {
    form.put(route("newstudents.update", props.newstudent?.id));
};
</script>
