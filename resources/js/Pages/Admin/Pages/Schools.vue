...
console.log(props.schoolToEdit);
...
function openModalEdit(school) {
  ...
  editForm.schoolAddress = school.address;
...
const editForm = useForm({
  id: props.schoolToEdit?.id,
  schoolName: props.schooltoEdit?.school_name,
  schoolAddress: props.schooltoEdit?.school_address,
  schoolLogo: null,
...
const submitEdit = () => {
  ...
  console.log("Edit ID:", editForm.schoolName);
  router.post(
    route("schools.update", editForm.id),
    {
      _method: "put",
      id: editForm.id,
  ...
  <AdminLayout>
    <div class="h-screen mt-16">
      <div class="flex justify-end">
        ...
        <PrimaryButton
          class="px-3 py-2 mx-6 text-white font-semibold rounded"
          @click="toggleModal"
          >Add New HTE</PrimaryButton
        >
      </div>
            ...
            <ReusableCard v-for="school in schools" :key="school.id">
              ...
              <div>
                ...
                <button
                  ...
                  class="px-2 py-2 text-white bg-indigo-500 hover:bg-indigo-400 rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
                  More info
                </button>

                <button
                  @click="openModalEdit(school)"
                  class="px-2 py-2 ml-3 text-white bg-green-500 hover:bg-green-400 rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
                  Edit HTE
                </button>
              ...
              >
                ...
                <div class="grid grid-cols-2 gap-5">
                  <div class="col-span-1 mb-5">
                    ...
                    <input
                      type="text"
                      v-model="editForm.required_programs"
                      name="required_programs"
                      id="required_programs"
                      placeholder="Programs"
                      class="w-full rounded-md border border-[#e0e0e0] bg-white py-3 px-6 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md"
                ...
                <div class="mb-6 pt-4">
                  ...
                  <div
                    class="mb-5 rounded-md bg-[#F5F7FB] py-4 px-8"
                    v-if="editForm.schoolLogo"
                  >
                    <div class="flex items-center justify-between">
                      <span
                        class="truncate pr-3 text-base font-medium text-[#07074D]"
                      >
                        {{ editForm.schoolLogo.name }}
                      </span>
                      <button class="text-[#07074D]">
                        <svg
                          width="10"
    ...
    <dialog id="myModalEdit" class="p-5 bg-white rounded-md">
      <div class="flex flex-col w-full h-auto" v-if="schoolEdit">
        <!-- Header -->
        <div class="flex w-full h-auto justify-between items-center">
          ...
          <div
            onclick="document.getElementById('myModalEdit').close();"
        ...
        <form
          ...
          method="POST"
        >
          <input type="hidden" v-model="editForm.id" name="id" />
          <div class="grid grid-cols-2 gap-5">
            <div class="col-span-1 mb-5">
              <label
                for="schoolName"
        ...
        <div class="container my-4 px-6 mx-auto">
          ...
          <section class="text-gray-800">
            <div class="flex flex-wrap">
              ...
              >
                <div
                  class="bg-white p-3 flex items-center justify-between ml-6 mb-4"
                >
                  <div
                  ...
                  >
                    <img
                      :src="selectedInstitution.school_logo"
