...
<template>
    ...
    <AdminLayout>
        <div class="mt-16">
            ...
            <h1></h1>
            <Link :href="route('coordinators.create')" class="px-3 py-2 text-white font-semibold bg-indigo-500 hover:bg-indigo-700 rounded">New Coordinator</Link>
           </div>
            <div class="mt-6">
            <!-- <Table>
                    <template #header>
                    ...
                    <template #default>
                       ...
                       <TableRow class="overflow-auto" v-for="coordinator in coordinators" :key="coordinator.id">
                            ...
                            <TableDataCell>{{ coordinator.id }}</TableDataCell>
                            <TableDataCell class="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap dark:text-white">
                                <img class="w-10 h-10 rounded-full" src="@/Assets/profile.jpg" alt="Jese image">
                                    <div class="pl-3">
                                    <div class="text-base font-semibold">{{ coordinator.full_name}}</div>
                                    <div class="font-normal text-gray-500">{{ coordinator.email}}</div>
                                     </div>  
                            </TableDataCell>
                            ...
                            <TableDataCell class="space-x-4">
                                <Link :href="route('coordinators.edit', coordinator.id)"  class="text-green-400 hover:text-green-600">Edit</Link>
                                <Link :href="route('coordinators.destroy', coordinator.id)" method="DELETE" as="button" class="text-red-400 hover:text-red-600">Delete</Link>
                            </TableDataCell>
                        </TableRow>
                    </template>
                </Table> -->
    ...
    <div class="pb-6">
        <div class="flex flex-wrap justify-center">
            <div class="flex justify-center w-full">
                <div class="relative">
                    <img src="@/Assets/maamAriaso.jpg" class="dark:shadow-xl border-white dark:border-gray-800 rounded-full align-middle border-8 absolute -m-16 -ml-18 lg:-ml-16 max-w-[150px]" />
                </div>
            </div>
        </div>
        <div class="mt-2 mt-20 text-center">
            <h3 class="mb-1 text-2xl font-bold leading-normal text-gray-700 dark:text-gray-300">Rowena N. Ariaso Ed.D.</h3>
            <div class="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                <!-- /typography/_h3.antlers.html -->
                <div class="text-sm font-bold tracking-wide text-gray-600 dark:text-gray-300 font-mono text-xl">Internship Supervisor(BEEd)</div>
...
<div class="relative w-full group max-w-md min-w-0 mx-auto mt-6 mb-6 break-words bg-white border shadow-2xl dark:bg-gray-800 dark:border-gray-700 md:max-w-sm rounded-xl">
    <div class="pb-6">
        <div class="flex flex-wrap justify-center">
            <div class="flex justify-center w-full">
                <div class="relative">
                    <img src="@/Assets/ddd.jpg" class="dark:shadow-xl border-white dark:border-gray-800 rounded-full align-middle border-8 absolute -m-16 -ml-18 lg:-ml-16 max-w-[150px]" />
                </div>
            </div>
        </div>
        <div class="mt-2 mt-20 text-center">
            <h3 class="mb-1 text-2xl font-bold leading-normal text-gray-700 dark:text-gray-300">Maria Lourdes G. Tan. Ed.D.</h3>
            <div class="flex flex-row justify-center w-full mx-auto space-x-2 text-center">
                <!-- /typography/_h3.antlers.html -->
                <div class="text-sm font-bold tracking-wide text-gray-600 dark:text-gray-300 font-mono text-xl">Internship Supervisor(BSEd)</div>
                <!-- End: /typography/_h3.antlers.html -->
            </div>
            <div class="w-full text-center">
                <div class="flex justify-center pt-8 pb-0 lg:pt-4">
