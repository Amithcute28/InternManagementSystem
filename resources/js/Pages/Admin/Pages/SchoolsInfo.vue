...
const form = useForm({
        ...
        school_address: props.school?.school_address,
      ...
      <div class="flex flex-wrap items-center">
        ...
        <div class="bg-white p-3 flex items-center justify-between ml-6 mt-4 mb-4">
                    <div class="flex space-x-6 items-center">
                        <img :src="image" class="w-auto h-24 rounded-lg"/>
                        <div>
                            <p class="font-semibold text-2xl">{{ school.school_name }}</p>
                            <p class="font-semibold text-lg text-gray-400">{{ school.school_address }}</p>
                        </div>              
                    </div>
                </div>
