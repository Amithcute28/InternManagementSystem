    ...
    <AdminLayout>
        <div class="max-w-7xl mx-aut mt-16">
           <div class="flex justify-between">
            <h1></h1>
            <Link :href="route('students.create')" class="px-3 py-2 text-white font-semibold bg-indigo-500 hover:bg-indigo-400 rounded-lg focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">New Students</Link>
           </div>
            <div class="mt-6">
                <Table>
                    <template #header>
                    ...
                    <template #default>
                        ...
                        <TableRow class="overflow-auto" v-for="student in students" :key="student.id">
                            ...
                            <TableDataCell class="space-x-4">
                                <Link :href="route('students.edit', student.id)"  class="text-green-400 hover:text-green-600">Edit</Link>
                                <Link :href="route('students.destroy', student.id)" method="DELETE" as="button" class="text-red-400 hover:text-red-600">Delete</Link>
                            </TableDataCell>
                        </TableRow>
                    </template>
                </Table>
