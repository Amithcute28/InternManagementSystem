    ...
    <div class="bg-white pb-10 px-10 rounded-xl shadow-xl mt-16">
      ...
      <div class="text-gray-700">
        <form @submit.prevent="submit" action="#" method="POST">
          ...
          <button
            type="submit"
            class="flex justify-center block w-full text-white text-sm font-semibold rounded-lg bg-indigo-500 hover:bg-indigo-400 focus:outline-none focus:shadow-outline focus:bg-gray-100 hover:shadow-xs p-3 my-4"
          >
            Update students
          </button>
        </form>
